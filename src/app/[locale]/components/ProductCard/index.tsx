...
import { trimmed } from "../../utils/general";
    ...
    <ProductBox>
      <Options>
        <Flex direction="column" gap="0.5rem" align="end">
          ...
          {product.discount_percentage && <IsDiscount>{product.discount_percentage}% Off</IsDiscount>}
          {product.is_delivery && <IsFreeShipping>Free Shipping</IsFreeShipping>}
        </Flex>
